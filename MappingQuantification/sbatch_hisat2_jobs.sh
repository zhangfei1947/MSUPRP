...
do
    ...
    echo ${SAMPLE}
    echo sbatch --export=SAMPLE="$SAMPLE",FILENAME1="$FILENAME1",FILENAME2="$FILENAME2" -t 4:00:00 -N 1 -n 4 -c 1 --mem-per-cpu 3G -J HISAT2 hisat2.job
    sbatch --export=SAMPLE="$SAMPLE",FILENAME1="$FILENAME1",FILENAME2="$FILENAME2" -t 4:00:00 -N 1 -n 4 -c 1 --mem-per-cpu 3G -J HISAT2 hisat2.job
    sleep 1s
done
