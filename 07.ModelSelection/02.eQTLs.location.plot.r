...
wkpath = "/mnt/scratch/zhangf37/PROJECT/20190813_MSUPRP/07.ModelSelection/01.eQTL"
setwd(wkpath)
...
#     theme(legend.title=element_blank()) + theme(legend.position=c(0.1,0.95)) + theme(legend.text=element_text(size=12)) +
...
ggsave("eQTL.location.pdf", width=42, height=35, units="cm")
ggsave("eQTL.location.png", width=21, height=18, units="cm")