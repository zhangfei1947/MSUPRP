...
QTL_res_file = "/mnt/scratch/zhangf37/PROJECT/20190813_MSUPRP/00.Scripts/07.ModelSelection/QTL.results.txt"
modelselect_file = "/mnt/scratch/zhangf37/PROJECT/20190813_MSUPRP/07.ModelSelection/01.eqtl.model.selection"
