...
`Rscript /mnt/scratch/zhangf37/PROJECT/20190813_MSUPRP/00.Scripts/05.mappingQTL/05.shuffle.split.pheno.r 0 15`

## prepare scripts to gcta and sbumit
phenofile_list=`ls genetpm.nqt.gcta.pheno.txt.*.names|awk '{ORS=",";print$0}'`
python /mnt/scratch/zhangf37/PROJECT/20190813_MSUPRP/00.Scripts/05.mappingQTL/05.generate.multiple.gcta.cmd.py ${phenofile_list} ${dir}/${wkdir}
