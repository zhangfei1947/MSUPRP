...
pheno = read.table(pheno_file,header=TRUE,row.names=1)  #row:gene   col:sample
pheno = pheno[,-which(colnames(pheno) %in% c("X1833","Var","log2Var","MAD","log2MAD","CV","span","skewness","num_nan","num_2","num_100","MeanAD","sexRatio","log2MeanAD","kurtosis"))]
